...
import IscCover from '../themes/isc/layouts/cover.vue'

defineOptions({ inheritAttrs: false })
const config = useTouyingConfig()
const component = computed(() =>
  config.value.preset === 'university' ? UniversityCover : 
  config.value.preset === 'simple' ? SimpleCover : 
  config.value.preset === 'isc' ? IscCover : DewdropCover,
)
</script>
